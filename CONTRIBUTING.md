...
For patch contributions, see our [Developer Documentation](https://github.com/NASA-AMMOS/aerie-docs/wiki) for more details on how to set up your local environment, to best contribute to our project. 
...
- [Issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) - a regularly monitored area to report issues with our software or propose changes
- [Discussion board](https://github.com/NASA-AMMOS/aerie-docs/discussions) - a permanently archived place to hold conversations related to our project, and to propose as well as show+tell topics to the contributor team. This resource can be searched for old discussions.
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
See our list of issues at: https://github.com/NASA-AMMOS/aerie-docs/issues
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) first.

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) first
...
Take a look at our [pull requests tracking system](https://github.com/NASA-AMMOS/aerie-docs/pulls), and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues) before considering any documentation contributions. Here's some guidelines:
...
- Hosted documentation
  - [Wiki Main-page](https://github.com/NASA-AMMOS/aerie-docs/wiki)
- Discussion Boards
  - [Discussions](https://github.com/NASA-AMMOS/aerie-docs/discussions)
...
- Answer open questions in our [discussion forum](https://github.com/NASA-AMMOS/aerie-docs/discussions)
- Answer open questions mentioned in our [issue tracking system](https://github.com/NASA-AMMOS/aerie-docs/issues)
